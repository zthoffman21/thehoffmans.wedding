  ...
  return (
    ...
    >
            ...
            <figure key={p.key} className="mb-4 break-inside-avoid">
              <div className="relative overflow-hidden rounded-xl shadow-sm ring-1 ring-white/10">
                <img
                  ...
                  loading="lazy"
                  src={cfImg(p.key, 900)}
                  srcSet={`${cfImg(p.key, 480, 70)} 480w, ${cfImg(p.key, 900, 75)} 900w, ${cfImg(
                    p.key,
                    1400,
                    75
                  )} 1400w`}
                  ...
                  style={
                    p.width && p.height ? { aspectRatio: `${p.width} / ${p.height}` } : undefined
                  }
                />
      ...
      {loading && initialLoaded && (
        <p className="mt-4 text-center text-white/70">Loading…</p>
      )}
