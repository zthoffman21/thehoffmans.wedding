...
const IconCake = () => <Icon path="M12 3v4m6 5H6m12 0v6H6v-6m12 0a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3" />;
const IconUsers = () => <Icon path="M16 11a4 4 0 1 0-8 0m12 6a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4" />;
const IconMapPin = () => (
  ...
  return (
    <section className="relative min-h-screen overflow-x-hidden bg-[#F2EFE7]">
      ...
      <div className="relative z-20">
        {/* Unified vertical stack controls spacing */}
        <div className="mx-auto max-w-5xl px-4 space-y-4 sm:space-y-6 md:space-y-10">
          ...
          {/* Mini quick links (mobile only, subtle) */}
          <div className="md:hidden">
            <div className="mx-auto w-fit rounded-xl bg-[#FAF7EC]/30 backdrop-blur-[2px] ring-1 ring-black/5 shadow-[0_4px_18px_rgba(0,0,0,0.10)]">
              <div className="flex flex-wrap items-center gap-1 p-2">
                <Link
                  to="https://www.aspenandalston.com/"
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 rounded-lg border border-black/10 bg-[#FAF7EC]/55 px-2 py-1 text-[10.5px] font-medium text-[#2C2A28] shadow-sm hover:bg-white/70 focus:outline-none focus:ring-2 focus:ring-black/10 active:translate-y-px"
                  aria-label="Open the venue website"
                >
                ...
                >
                  <svg viewBox="0 0 24 24" className="size-3 fill-none stroke-current">
                    <path
                      d="M12 21s7-4.35 7-10a7 7 0 1 0-14 0c0 5.65 7 10 7 10zm0-8a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
            ...
            <div className="space-y-6 md:col-span-3">
              ...
              <Card>
                ...
                <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <AttireCard
                    title="For Men"
                    items={["Chinos or dress pants", "Button-down or nice polo", "Optional jacket"]}
                  />
                  <AttireCard
                    title="For Women"
                    items={["Short or midi dresses", "Light colors or florals", "Comfortable heels/flats"]}
                  />
                  <AttireCard
                    title="General Tips"
            ...
            <div className="space-y-6 md:col-span-2">
              ...
              <Card>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-neutral-800">
                  <li>
                    Cocktail hour begins at <strong>6:00 PM</strong>.
                  </li>
                  <li>
                    Dinner begins at <strong>7:30 PM</strong>.
                  </li>
                  <li>
                    Cake cutting around <strong>8:30 PM</strong>.
                  </li>
                </ul>
              </Card>
              ...
              <Card>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-neutral-800">
                  <li>
                    All events are at <strong>Aspen & Alston</strong>.
                  </li>
                  <li>On-site parking available.</li>
                  <li>Please plan for an adults-focused evening.</li>
                  <li>
                    Couple's exit at <strong>10:00 PM</strong>; venue closes at <strong>11:00 PM</strong>.
                  </li>
                </ul>
              </Card>
              ...
              <div className="hidden md:block">
                <Card>
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    <PerforatedButton to={"https://www.aspenandalston.com/"} arrowColor="#567D9C" external={true}>
                      <span>The Venue</span>
                    </PerforatedButton>
                    <PerforatedButton
                      to={
                        "https://www.google.com/maps/place/Aspen+%26+Alston/@40.3431241,-83.1855779,17z/data=!3m1!4b1!4m6!3m5!1s0x8838e705cd847ad5:0x9dc9dce561fde97b!8m2!3d40.34312!4d-83.183003!16s%2Fg%2F11vbybgc95?entry=ttu&g_ep=EgoyMDI1MDkyMi4wIKXMDSoASAFQAw%3D%3D"
                      }
                      arrowColor="#567D9C"
                      external={true}
                    >
...
function TimelineRow({ time, label }: { time: string; label: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="mt-0.5 rounded-full bg-black/80 px-2.5 py-1 text-xs font-medium text-[#F2EFE7] shadow-sm">
        {time}
      </div>
